...
keymap.bind({
  lead("fb", "n"):exec("Telescope buffers"),
  lead("ff"):exec("Telescope find_files"),
  lead("fg"):exec("Telescope live_grep"),
  lead("fh"):exec("Telescope help_tags"),
  lead("fe"):exec("Telescope file_browser"),
