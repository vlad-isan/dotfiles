...
#+begin_src emacs-lisp
  ...
  ;; Register PPX
  (defvar gptel--ppx (gptel-make-openai "Perplexity"
  ...
  ;; Open and set PPX backend - THIS DOES NOT WORK!!!!!
  (defun vld/gptel-ppx ()
    (interactive)
    (let ((gptel-backend gptel--ppx)
          (gptel-model "pplx-70b-online"))
